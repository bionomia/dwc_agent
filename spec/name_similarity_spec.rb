...
describe "Test the similarity of given names" do
  ...
  it "should give J. and John a score of 1" do
    given1 = "J."
    given2 = "John"
    expect(DwcAgent.similarity_score(given1,given2)).to eq 1
  end

  it "should give John R. and John a score of 1.1" do
    given1 = "John R."
    given2 = "John"
    expect(DwcAgent.similarity_score(given1,given2)).to eq 1.1
  end
  ...
  it "should give John R. and J.R. a score of 2" do
    given1 = "John R."
    given2 = "J.R."
    expect(DwcAgent.similarity_score(given1,given2)).to eq 2
  end
  ...
  it "should give Jim B. and Jay a score of 0" do
    given1 = "Jim B."
    given2 = "Jay"
    expect(DwcAgent.similarity_score(given1,given2)).to eq 0
  end
